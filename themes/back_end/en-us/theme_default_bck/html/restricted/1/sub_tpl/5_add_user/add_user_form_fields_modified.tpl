<form enctype="multipart/form-data" role="form" action="?page_id=5&modified_id={{user_id_bck}}" method="post">
...
<input id="folder" value="{{user_theme_bck}}" name="user_theme_folder_bck">
<label for="access">Access</label>
<input id="access" value="{{user_level_access_bck}}" name="user_level_access_bck">
<label for="user-lang">Lang</label>
<select id="user-lang" name="user_theme_lang_bck">{{user_lang_bck}}</select>
