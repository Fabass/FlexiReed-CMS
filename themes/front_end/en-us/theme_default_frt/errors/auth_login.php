<!DOCTYPE html>
<html lang="<?php echo THEME_LANG_FRT; ?>">
<head>
<meta charset="utf-8">
<meta name="description" content="Default home page front-end">
<meta name="generator" content="FlexiReed CMS">
<title>Login Panel (front-end)</title>
<link rel="stylesheet" href="../themes/front_end/<?php echo THEME_LANG_FRT; ?>/<?php echo THEME_FOLDER_FRT; ?>/css/normalize.css">
</head>
<body>
<?php
$errors = $e->getError();
...
<script src="../themes/front_end/<?php echo THEME_LANG_FRT; ?>/<?php echo THEME_FOLDER_FRT; ?>/js/jsfile.js"></script>
</body>
</html>